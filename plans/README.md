...
| 006 | [Fail-fast `check` and CI hygiene](006-fail-fast-check-and-ci-hygiene.md) — lint/format first, Node pins, Playwright cache, Wrangler timeout, keep `.vite/` off the site                                                                       | S       | low    | —                    | partial: timeout, .assetsignore done (f773fdc) |
