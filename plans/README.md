...
| 011 | [HTML input](011-html-input.md) — brief 007 M4; neutral engine core, `rehypeTypography`, byte-preserving HTML splice with entity replacement, hanging `source: 'html'`                                                                         | L       | medium | —                    | done                                                       |
