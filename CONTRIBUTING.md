...
The first command builds the package and both apps, checks types, runs unit/renderer tests, and validates the packed package in a clean consumer. The browser suites cover the landing page and local Vercel/Cloudflare flows. See the [fixture README](examples/chat-integration/README.md) for browser prerequisites and local servers.
